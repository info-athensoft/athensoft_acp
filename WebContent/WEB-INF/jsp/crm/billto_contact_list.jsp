...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Athensoft | CRM - Customer contact</title>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END THEME PANEL -->
                    <h1 class="page-title"> CRM System <small>manage customers</small></h1>
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
							...
							<li>
								<a href="#">Customer billing contact</a>
							</li>
						</ul>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-shopping-cart"></i>Customer Billing contact Listing <span class="caption-helper">listing customer billing contact, search, group action...</span></div>
                                    <div class="actions">
                                ...
                                <div class="portlet-body">
                                    <div class="table-container">
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_billtoContactList">
                                            <thead>
...
<script type="text/javascript" src="${webapp_name}/assets/pages/scripts-local/crm/billto-contact.js"></script>
<script type="text/javascript" src="${webapp_name}/assets/pages/scripts-local/global-validate.js"></script>
<script type="text/javascript" src="${webapp_name}/assets/pages/scripts-local/crm/billto-contact-list.js"></script>
